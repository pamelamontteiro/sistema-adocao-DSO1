...
class Animal(ABC):
    @abstractmethod
    def __init__(self, numero_chip: int, nome: str, raca: str, tamanho: str, castrado=bool):
        self.__historicos_vacinacao = []  # Lista para armazenar histórico de vacinação
        self.__numero_chip = numero_chip
        self.__nome = nome
        self.__raca = raca
        self.__tamanho = tamanho  # Assumindo que o tamanho seja sempre uma string válida
    ...
    def listar_vacinas_historico(self):
        ...
        lista_historico = [historico['vacina'] for historico in self.__historicos_vacinacao]
    ...
    def registrar_vacina(self, data_vacina: date, vacina: str):
        ...
        print(f'Vacina "{vacina}" registrada com sucesso para {self.nome} na data {data_vacina}')
